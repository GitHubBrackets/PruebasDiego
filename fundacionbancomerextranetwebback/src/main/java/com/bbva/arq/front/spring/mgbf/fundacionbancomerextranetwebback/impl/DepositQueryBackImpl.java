...
/**
 * Class DepositQueryBackImpl implements the DepositQueryBack interface Contains
 * the implementations of the method depositQueryArmed to consume the service
 * MGFBTH01
 * 
...
public class DepositQueryBackImpl implements DepositQueryBack {
     ...
     */
    @Override
    public ResponseEntity<?> depositQueryArmed(DepositQueryInDTO beanScholarIn,
            HttpServletRequest request) {
        LOG.info("Inside depositQueryArmed");
        ...
        try {
            ...
            initialDepositQueryClientServiceImpl = (InitialDepositQueryServiceImpl) context
            .getBean("depositQuerServiceCli");
            ...
            response = initialDepositQueryClientServiceImpl.depositQuery(
                    beanScholarIn, headers);
